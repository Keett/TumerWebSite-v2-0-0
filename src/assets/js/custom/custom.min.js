...
!function (e) { 
    ...
    e(document).ready(function () { 
        ...
        e(document).on("click", ".inner-navigation.show", function (t) { 
            ...
            var a = e(".off-canvas-sidebar"); a.is(t.target) || 0 !== a.has(t.target).length || e("body").removeClass("off-canvas-sidebar-open") 
        }).resize(), e(".off-canvas-sidebar-wrapper").css("margin-right", "-" + t() + "px"), e(window).on("resize", function () { 
            var t = Math.max(e(window).width(), window.innerWidth); t <= 991 && e("body").removeClass("off-canvas-sidebar-open") 
        }); 
        var z = e(".filters"), E = e(".row-portfolio"); 
        e("a", z).on("click", function () { 
            var t = e(this).attr("data-filter"); 
            return e(".current", z).removeClass("current"), e(this).addClass("current"), E.isotope({ filter: t }), !1 
